...
<h1>Register New Account</h1>
	...
	<form action="registration.do" method="POST">
		...
		<input type="text" name="firstName" required size="25" /> <br> <br>
		
		<label for="lastName"> <strong>*Last Name:</strong></label> <br>
				<input type="text" name="lastName" required size="25" /> <br> <br>

		<label for="userName"> <strong>*Username:</strong></label> <br>
		<input type="text" name="username"required size="25" /> <br> <br>
		
		<label for="password"> <strong>*Password:</strong></label> <br>
		<input type="password" name="password" required size="25" /> <br> <br>
...
<br>
	...
	<h3>Enter Contact Information</h3>
		...
		<input type="text" name="phone" required size="25" /> <br> <br>
		...
		<input type="text" name="email" required size="25" /> <br> <br>
			
		<label for="streetAddress"> <strong>*Street Address:</strong></label> <br>
		<input type="text" name="street" required size="25" /> <br> <br>
			
		<label for="city"> <strong>*City:</strong></label> <br>
		<input type="text" name="city" required size="25" /> <br> <br>
		...
		<input type="text" name="zipCode" required size="25" minlength="5" maxlength="15"/> <br> <br>
